...
void OLED7_send8BitNumber(uint8_t number, int16_t x, int16_t y)
{
	char tens = (number / 10) + '0';
	char units = (number % 10) + '0';
	
	OLED7_sendCharXYI(tens, x, y);
	OLED7_sendCharXYI(units, x, y + 1);
}
